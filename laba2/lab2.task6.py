def sort():
    ...
    with open('text.txt', 'r', encoding = 'utf-8') as file:
        for line in file:
            for i in line:
                if i.isdigit():#проверяет, является ли текущий символ цифрой.
                    stack_numbers.append(i)
                elif i.isalpha():#символ является буквой.
                    if i.lower() in rus:#нижний регистр
...
for i, stack in enumerate(sort()):#перечислитель
    print(stack)
